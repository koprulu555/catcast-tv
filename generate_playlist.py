...
class CatCastM3UGenerator:
        ...
        for attempt in range(max_retries):
            try:
                ...
                if data.get('status') == 1 and 'data' in data:
                    ...
                    # Sadece çevrimiçi kanalları filtrele
                    online_channels = [ch for ch in channels if ch.get('is_online') == True]
                    print(f"Sayfa {page_num}: Toplam {len(channels)} kanal, {len(online_channels)} çevrimiçi kanal bulundu")
    ...
    def generate_playlist(self):
        ...
        # SAYFA SAYISI 23'ten 50'ye ÇIKARILDI - 471, 480 ve 481 KORUNDU
        # 471 sayfası 480'den önce eklendi
        pages = list(range(1, 51)) + [471, 480, 481]  # 1-50 + 471 + 480 + 481
        ...
        print(f"Toplam {total_channels} çevrimiçi kanal işlendi")
